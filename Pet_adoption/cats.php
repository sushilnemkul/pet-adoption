...
<head>
    ...
    <link rel="stylesheet" href="dogcatList.css">
</head>
<body>
    <div class="navbar">
        <div class="logo"><img src="logo.png" alt="adopt" width="155px"></div><style></style></h2>  
          <ul class="menu">
   ...
   <?php include 'header.php';?>
       ...
       <div class="cards">
        ...
        <div class="des">
          <P> Age: 1.5 <br>Breed: Japanese Spitz</P>
        </div>
        <div class="btn1">
          <button><a href="#">Details</a></button>
          <button ><a href="#">Adopt</a></button>
              ...
              <footer class="footer">
                <div class="container">
                  <div class="row">
                    <div class="col-md-4">
                      <h4>About Us</h4>
                      <p>We are a non-profit organization dedicated to finding forever homes for pets in need.</p>
                    ...
                    <div class="col-md-4">
                      ...
                      <p>Email: <a href="mailto:info@petadoption.org">info@petadoption.org</a></p>
                      <p>Address: 123 Main St, Anytown, USA</p>
                    </div>
                  </div>
                </div>
                <div class="copyright">
                  <p>&copy; 2023 Pet Adoption Organization. All rights reserved.</p>
                </div>
              </footer>
                     </div> -->
<!-- </body>
